        ...
        if (response) {
            ...
            $.each(response, function (index, product) {
                table += '<tr data-id="' + product.product_id + '" data-name="' + product.product_name + '" data-unit="' + product.uom_id + '" data-price="' + product.product_price + '">' +
                    ...
                    '<td><button type="button" class="btn btn-sm btn-primary pull-right update-product" data-toggle="modal" data-target="#editproductModal"> Edit Product  </button></td>' +
